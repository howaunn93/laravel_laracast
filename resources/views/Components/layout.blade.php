        ...
        <div class="min-h-full">
            <nav class="bg-gray-800">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex h-16 items-center justify-between">
                        <div class="flex items-center">
                            <div class="shrink-0">
                                <img class="size-8" src="https://cdn.freebiesupply.com/logos/large/2x/spider-man-4-logo-svg-vector.svg" alt="Your Company" />
                            </div>
                        ...
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <div class="relative ml-3">
                                <div>
                                    ...
                                    <img class="size-8 rounded-full" src="https://logos-world.net/wp-content/uploads/2020/02/Iron-Man-Logo.png" alt="" />
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="border-t border-gray-700 pt-4 pb-3">
                    ...
                    <div class="shrink-0">
                        <img class="size-10 rounded-full" src="https://logos-world.net/wp-content/uploads/2020/02/Iron-Man-Logo.png" alt="" />
                    </div>
                    <div class="ml-3">
                        <div class="text-base/5 font-medium text-white">HA</div>
                        <div class="text-sm font-medium text-gray-400">ha@gmail.com</div>
                    </div>
